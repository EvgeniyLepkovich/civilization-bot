package com.civilization.custom;
...
public class CWC_LongestLineWithHeaderAndFooter implements AT_ColumnWidthCalculator {
     ...
     */
    public CWC_LongestLineWithHeaderAndFooter add(final int minWidth, final int maxWidth) {
            ...
            if(row.getType()== TableRowType.CONTENT) {
                ...
                for(int i=0; i<cells.size(); i++) {
                    if(cells.get(i).getContent()!=null){
                        ...
                        if (cells.stream().anyMatch(cell -> cell.getContent() == null || StringUtils.isBlank(cell.getContent().toString()))) {
                            continue;
                        }
